...
public class UserInfoActivity extends AppCompatActivity {
    ...
    public void init(){
        ...
        layoutName = (TextInputLayout)findViewById(R.id.txtLayoutNameUserInfo);
        txtName = (TextInputEditText) findViewById(R.id.txtNameUserInfo);
        layoutLastname = (TextInputLayout) findViewById(R.id.txtLayoutLastnameUserInfo);
        txtLastname = (TextInputEditText)findViewById(R.id.txtLastnameUserInfo);
